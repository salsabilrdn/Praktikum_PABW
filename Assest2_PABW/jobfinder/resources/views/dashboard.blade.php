<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-300">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="border border-blue-300 px-4 py-2 text-left">Nama File</th>
                        <th class="border border-blue-300 px-4 py-2 text-left">Aksi</th>
                    </tr>
                </thead>
                <tbody>
        ...
        @if(session('success'))
        <div class="mt-4 p-2 bg-green-200 text-blue-800 rounded">
            {{ session('success') }}
        </div>
        @endif
