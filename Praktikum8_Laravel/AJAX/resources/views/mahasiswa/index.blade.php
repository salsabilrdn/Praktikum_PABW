...
<div class="card">
 ...
 <div class="card-body">
 <button class="btn btn-primary mb-3" id="btn-tambah"><i class="fas faplus"></i> Tambah Data</button>
...
<div class="modal fade" id="modal-mahasiswa" tabindex="-1" aria-hidden="true">
 ...
 @csrf {{-- Token keamanan Laravel, yang mana jika mengunakan AJAX
harus mengunakan csrf --}}
...
keamanan
 ...
 <td>
 {{-- Tombol edit --}}
 <button class="btn btn-sm btn-warning btn-edit" dataid="${item.id}">
 <i class="fas fa-edit"></i>
 </button>
 {{-- Tombol hapus --}}
 <button class="btn btn-sm btn-danger btn-delete" dataid="${item.id}">
