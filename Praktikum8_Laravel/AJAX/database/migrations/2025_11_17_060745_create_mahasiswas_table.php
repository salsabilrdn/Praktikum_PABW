...
return new class extends Migration {
    public function up()
    {
        ...
        Schema::create('mahasiswas', function (Blueprint $table) { // yang berartimenyuruh untuk membuatkan tabel 'mahasiswas' di DB, sesuai isi kolom dibawah ini, yang mana Laravel secara otomatis menambahkan‘s’.
